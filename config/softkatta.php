...
return [
    'company_api_url' => rtrim(env('SOFTKATTA_COMPANY_API_URL', 'https://api.softkatta.in/api/v1/company'), '/'),
    'public_api_key' => env('SOFTKATTA_PUBLIC_API_KEY', ''),
    'api_secret' => env('SOFTKATTA_API_SECRET', ''),
    'product_slug' => env('SOFTKATTA_PRODUCT_SLUG', 'nursery-school-management-software'),
    ...
    // Public marketing GETs still die on Suspend (empty modules force-check via middleware).
