...
class LiveKitService
{
    ...
    {
        $this->integrations->applyLivekitConfig();
    ...
    public function ensureConfigured(): void
    {
        if (! $this->isConfigured()) {
            throw ValidationException::withMessages([
                'livekit' => 'Built-in camera streaming is not configured. Enable LiveKit in Admin → Settings → LiveKit and start the LiveKit server.',
            ]);
        }
    }
