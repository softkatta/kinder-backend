...
class SettingsController extends Controller
{
    ...
    private function profileMrValidationRules(): array
    {
        ...
        foreach (self::PROFILE_LOCALIZED_KEYS as $key) {
            $max = match ($key) {
                ...
                'home_why_panel_desc', 'vision', 'mission', 'meta_description', 'about_visit_desc', 'about_page_subtitle' => 1000,
                'address' => 500,
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        if ($request->has('profile')) {
            $this->updateProfile($request->validate(array_merge([
                ...
                'profile.about_page_label' => ['sometimes', 'nullable', 'string', 'max:120'],
                'profile.about_page_title' => ['sometimes', 'nullable', 'string', 'max:255'],
                'profile.about_page_subtitle' => ['sometimes', 'nullable', 'string', 'max:500'],
                'profile.about_principal_label' => ['sometimes', 'nullable', 'string', 'max:120'],
                'profile.about_stat_years_label' => ['sometimes', 'nullable', 'string', 'max:120'],
                'profile.about_stat_programs_label' => ['sometimes', 'nullable', 'string', 'max:120'],
                'profile.about_stat_programs_value' => ['sometimes', 'nullable', 'string', 'max:60'],
                'profile.about_stat_safe_label' => ['sometimes', 'nullable', 'string', 'max:120'],
                'profile.about_stat_safe_value' => ['sometimes', 'nullable', 'string', 'max:60'],
                'profile.about_visit_title' => ['sometimes', 'nullable', 'string', 'max:255'],
                'profile.about_visit_desc' => ['sometimes', 'nullable', 'string', 'max:1000'],
    ...
    private function profilePayload(): array
    {
        ...
        return [
            ...
            'about_page_label' => $meta['about_page_label'] ?? null,
            'about_page_title' => $meta['about_page_title'] ?? null,
            'about_page_subtitle' => $meta['about_page_subtitle'] ?? null,
            'about_principal_label' => $meta['about_principal_label'] ?? null,
            'about_stat_years_label' => $meta['about_stat_years_label'] ?? null,
            'about_stat_programs_label' => $meta['about_stat_programs_label'] ?? null,
            'about_stat_programs_value' => $meta['about_stat_programs_value'] ?? null,
            'about_stat_safe_label' => $meta['about_stat_safe_label'] ?? null,
            'about_stat_safe_value' => $meta['about_stat_safe_value'] ?? null,
            'about_visit_title' => $meta['about_visit_title'] ?? null,
            'about_visit_desc' => $meta['about_visit_desc'] ?? null,
    ...
    private function updateProfile(array $data): void
    {
        ...
        foreach ([
            ...
            'about_page_label', 'about_page_title', 'about_page_subtitle', 'about_principal_label',
            'about_stat_years_label', 'about_stat_programs_label', 'about_stat_programs_value',
            'about_stat_safe_label', 'about_stat_safe_value',
            'about_visit_title', 'about_visit_desc',
            'favicon_image',
        ] as $homeField) {
